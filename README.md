...
**Windows users** can grab the latest [Minecraft Legacy Build](https://github.com/VayTheMan/LegacyMinecraft/releases/tag/Release). Download the `.zip` archive, extract to any folder, and launch `Minecraft.Client.exe`. Create a `username.txt` file in the same directory to set your player name.
